...
class CfgVehicles
{
	...
	class TerjeBookGunsmith1: TerjeBookBase
	{
		scope=2;
		displayName="#STR_TERJESKILL_BOOK_GUNSMITH1";
		hiddenSelectionsTextures[]={"TerjeSkills\Books\data\book_gunsmith1_co.paa"};
	...
	class TerjeBookGunsmith2: TerjeBookBase
	{
		scope=2;
		displayName="#STR_TERJESKILL_BOOK_GUNSMITH2";
		hiddenSelectionsTextures[]={"TerjeSkills\Books\data\book_gunsmith2_co.paa"};
	...
	class TerjeBookGunsmith3: TerjeBookBase
	{
		scope=2;
		displayName="#STR_TERJESKILL_BOOK_GUNSMITH3";
		hiddenSelectionsTextures[]={"TerjeSkills\Books\data\book_gunsmith3_co.paa"};
	...
	class TerjeBookGunsmith4: TerjeBookBase
	{
		scope=2;
		displayName="#STR_TERJESKILL_BOOK_GUNSMITH4";
		hiddenSelectionsTextures[]={"TerjeSkills\Books\data\book_gunsmith4_co.paa"};
	...
	class TerjeBookGunsmith5: TerjeBookBase
	{
		scope=2;
		displayName="#STR_TERJESKILL_BOOK_GUNSMITH5";
		hiddenSelectionsTextures[]={"TerjeSkills\Books\data\book_gunsmith5_co.paa"};
