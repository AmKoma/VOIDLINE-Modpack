modded class TerjeSettingsCollection
{
	...
	static int SKILLS_GUNSMITH_SHOOT_GAIN_CHANCE;
	static int SKILLS_GUNSMITH_SHOOT_GAIN_EXP;
	static int SKILLS_GUNSMITH_CLEAN_WEAPON_EXP_GAIN;
	...
	override void OnInit()
	{
		...
		RegisterRegion("Skills", "Gunsmith");
		SKILLS_GUNSMITH_SHOOT_GAIN_CHANCE = RegisterSettingFloat("Skills.GunsmithShootGainChance", "Skills", "Sets the chance the player will gain gunsmith experience for each weapon shot fired.", 0.15, true);
		SKILLS_GUNSMITH_SHOOT_GAIN_EXP = RegisterSettingInt("Skills.GunsmithShootGainExp", "Skills", "Sets the value of experience points that the player will gain per weapon shot. This parameter is also affected by ExperienceGainModifier.", 5, true);
		SKILLS_GUNSMITH_CLEAN_WEAPON_EXP_GAIN = RegisterSettingInt("Skills.GunsmithCleanWeaponExpGain", "Skills", "Sets the value of experience points that the player will gain for cleaning or repairing a weapon. This parameter is also affected by ExperienceGainModifier.", 25, true);
